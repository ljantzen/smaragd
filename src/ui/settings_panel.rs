...
/// field claims. Each row shows the language, its SPDX license identifier
/// inline (full review status/copyright/notes as a hover tooltip), and either
/// a "Download" button, a spinner while
