...
- Settings gains its own **Spell Check** category, with a **Dictionaries**
  ...
  Nine languages available at launch: English, Norwegian Bokmål, French,
  Russian, Georgian, Lithuanian, Persian, Turkmen, and Interlingue. Once
  downloaded, a dictionary is used immediately, no restart needed.
