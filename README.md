...
Binder, Backlinks, Metadata, Editor, Preview, Corkboard, and Pomodoro all dock together in one shared area via [`egui_dock`](https://github.com/Adanos020/egui_dock), wired up in `app.rs`'s `DockTab`/`AppTabViewer`.
