...
Binder and Editor are present from the moment a project is open; Backlinks, Tags, Bookmarks, Metadata, Preview, Corkboard, Story Grid, Belief Timeline, Pomodoro, Word Count, Collaborate, and Streak start closed. Any tab can be closed via its × button, and reopened again from **`View > Binder`**, **`View > Backlinks`**, **`View > Tags`**, **`View > Bookmarks`**, **`View > Preview`**, **`View > Corkboard`**, **`View > Story Grid`**, **`View > Belief Timeline`**, **`View > Metadata`**, **`Collaborate > Collaboration Panel`**, or (for Pomodoro, Word Count, and Streak) **`Tools > Pomodoro Timer`**/**`Tools > Word Count`**/**`Tools > Streak`** (most also have shortcuts — see [Keyboard Shortcuts](keyboard-shortcuts.md)). Toggling Preview, Corkboard, Story Grid, or Belief Timeline just opens or closes that tab next to the Editor rather than switching to an exclusive "view mode" — any combination of tabs can be open and arranged at once.
