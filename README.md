...
src/
  ...
  project/
    ...
    mod.rs                 Project: load/initialize, metadata, folder roles, trash/restore, create/rename/delete/reorder, story cards, backlinks scan, tag index/search
  ui/
